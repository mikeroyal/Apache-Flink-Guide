...
#### A guide covering Apache Flink including the applications, libraries and tools that will make you better and more efficient with Apache Flink development.
...
<img src="https://user-images.githubusercontent.com/45159366/137402847-edcb5fea-f721-4b1e-9ad5-ec808b07097a.png">
 ...
 Apache Flink Architecture. Source: [DataFlair](https://data-flair.training/blogs/flink-tutorial/)

# Table of Contents

1. [Apache Flink Learning Resources](https://github.com/mikeroyal/Apache-Flink-Guide#Apache-Flink-learning-resources)

2. [Apache Flink Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Apache-Flink-Guide#Apache-Flink-tools-libraries-and-frameworks)

3. [Kubernetes](https://github.com/mikeroyal/Apache-Flink-Guide#kubernetes)

4. [Docker](https://github.com/mikeroyal/Apache-Flink-Guide#docker)

5. [Machine Learning](https://github.com/mikeroyal/Apache-Flink-Guide#machine-learning)

6. [Algorithms](https://github.com/mikeroyal/Apache-Flink-Guide#Algorithms)

7. [Deep Learning Development](https://github.com/mikeroyal/Apache-Flink-Guide#Deep-Learning-Development)

8. [Reinforcement Learning Development](https://github.com/mikeroyal/Apache-Flink-Guide#Reinforcement-Learning-Development)

9. [Computer Vision Development](https://github.com/mikeroyal/Apache-Flink-Guide#computer-vision-development)

10. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Apache-Flink-Guide#nlp-development)

11. [Bioinformatics](https://github.com/mikeroyal/Apache-Flink-Guide#bioinformatics)

12. [Databases](https://github.com/mikeroyal/Apache-Flink-Guide#databases)

13. [CUDA Development](https://github.com/mikeroyal/Apache-Flink-Guide#cuda-development)

14. [MATLAB Development](https://github.com/mikeroyal/Apache-Flink-Guide#matlab-development)

15. [Java Development](https://github.com/mikeroyal/Apache-Flink-Guide#java-development)

16. [C/C++ Development](https://github.com/mikeroyal/Apache-Flink-Guide#cc-development)

17. [C# Development](https://github.com/mikeroyal/Apache-Flink-Guide#c-development)

18. [Python Development](https://github.com/mikeroyal/Apache-Flink-Guide#python-development)

19. [Go Development](https://github.com/mikeroyal/Apache-Flink-Guide#go-development)

20. [Scala Development](https://github.com/mikeroyal/Apache-Flink-Guide#scala-development)

21. [R Development](https://github.com/mikeroyal/Apache-Flink-Guide#r-development)


# Apache Flink Learning Resources
[Back to the Top](https://github.com/mikeroyal/Apache-Flink-Guide#table-of-contents)
...
# Apache Flink Tools, Libraries, and Frameworks
[Back to the Top](https://github.com/mikeroyal/Apache-Flink-Guide#table-of-contents)

[FlinkX](https://github.com/DTStack/flinkx) is a data synchronization tool based on [Apache Flink®](https://flink.apache.org/) that supports data synchronization/integration and streaming SQL computation.

[Flink Siddhi](https://github.com/haoch/flink-siddhi) is a light-weight library to run [Siddhi CEP](https://github.com/wso2/siddhi) within [Apache Flink®](https://flink.apache.org/) streaming application. Siddhi CEP is a lightweight and easy-to-use Open Source Complex Event Processing Engine (CEP) released as a Java Library under Apache Software License v2.0.
...
[Apache Bahir](https://bahir.apache.org) is a tool that provides extensions to distributed analytics platforms such as Apache Spark™ and Apache Flink®.

[Zeppelin](https://zeppelin.apache.org) is a web-based  notebook that enables data-driven, interactive data analytics and collaborative documents with SQL, Scala, Python, R and more.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Apache-Flink-Guide/pulls).
